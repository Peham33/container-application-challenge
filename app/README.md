# weckdengeparden-container-application-challenge project
...
You can then execute your native executable with: `./target/weckdengeparden-container-application-challenge-1.0.0-SNAPSHOT-runner`
